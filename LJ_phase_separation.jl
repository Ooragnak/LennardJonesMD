...
# https://www.sciencedirect.com/science/article/abs/pii/S000925091730310X
type_B = "Rn"
...
box_A = ((0, box_length), (0, box_length), (0, box_length))
box_B = ((0, box_length), (0, box_length), (0, box_length))
...
for i in 1:200
    ...
    i == 200 && println("Could not place all particles with rij_min_starting. Current minimum distance: ", minimum(dist))
end
